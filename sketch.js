...
function setup() {
 //this is the command to make our canvas fit our whole window (whole screen)
  canvas = createCanvas(windowWidth, windowHeight);

//we are creating the engine (in which this is called to be the universe)
  engine = Engine.create();
  world = engine.world;

// line 26 we are creating our object (playerBase)
